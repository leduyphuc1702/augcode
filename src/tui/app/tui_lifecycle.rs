...
impl App {
    pub(super) fn apply_restored_reload_input(&mut self, restored: RestoredReloadInput) {
        ...
        let has_acknowledged_interrupts = restored
    ...
    pub(super) fn new_minimal_with_session(
        ...
        let mut app = Self {
            ...
            swarm_enabled: features.swarm && features.agent_workflow,
            ...
            context_view_enabled: false,
            context_view_markdown: String::new(),
            context_view_updated_at_ms: 0,
            context_view_rendered_hash: 0,
